...
describe("TaskController", () => {
	...
	describe("getAllTasks", () => {
		...
		it("should return 500 when service throws an error", async () => {
			mockService.findAll.mockRejectedValue(new Error("Database connection failed"));
			const req = createMockRequest();
			const res = createMockResponse();
	...
	describe("updateTask", () => {
		...
		it("should return 404 when update task not found", async () => {
		...
		it("should return 400 for invalid update id", async () => {
			const req = createMockRequest({ params: { id: "abc" }, body: { title: "Updated Task" } });
			const res = createMockResponse();
	...
	describe("deleteTask", () => {
		...
		it("should return 404 when delete task not found", async () => {
